...
const char *gengetopt_args_info_help[] = {
  ...
  "  -b, --bin=STRING  binary to convert",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->bin_help = gengetopt_args_info_help[2] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVb:", long_options, &option_index);
